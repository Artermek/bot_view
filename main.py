    ...
    if task["photo_status"] == "done" and task["survey_status"] == "done":
        ...
        Ты — опытный психолог, анализирующий результаты анализа фотографий и психологического отчёта о ребёнке.
            ...
            "questionnaire": {
                ...
                { "name": "Коммуникативность",          "score": 13, "transcript": "норма / благополучие"},
             ...
             "transcript_questionnaire": {
                "scales": [
                    Результаты показывают, что у ребенка есть умеренные трудности в социальной сфере и выраженные трудности в самооценке и уверенности,
                    в то время как саморегуляция и эмоциональная сфера находятся в пределах нормы или легких сложностей. Высокая активность, отмеченная 
                    родителями, соответствует наблюдаемым результатам и может влиять на социальные взаимодействия и уверенность ребенка. Важно обратить 
                    внимание на поддержку самооценки и развитие навыков общения.
                ]
            },
