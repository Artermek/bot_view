            ...
            messages=[
                {
                    "role": "user",
                    "content": [
                        {"type": "text", "text": """Ты — ведущий клинический нейропсихолог и психодиагност с 20-летним стажем, специалист в проективных методиках, в частности тесте «Дом – Дерево – Человек». Перед тобой — скан или фотография детского рисунка. Твоя задача:
