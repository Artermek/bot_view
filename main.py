...
async def get_report(task_id: str):
    ...
    if task["photo_status"] == "done" and task["survey_status"] == "done":
        ...
        ❗ Используй только ключи из схемы и не добавляй новых.
        ...
        "house_tree_person": {
            "elements": [
            { "element": "Дом",     "features": "<…>", "conclusion": "<…>" },
            { "element": "Дерево",  "features": "<…>", "conclusion": "<…>" },
            { "element": "Человек", "features": "<…>", "conclusion": "<…>" }
            ],
            "overall": "<Общий вывод>"
        },
        ...
        "questionnaire": {
            "scales": [
            { "name": "Эмоциональная устойчивость", "score": <int>, "max": 25 },
            { "name": "Социальная адаптация",       "score": <int>, "max": 25 },
            { "name": "Саморегуляция",              "score": <int>, "max": 25 },
            { "name": "Коммуникативность",          "score": <int>, "max": 25 },
            { "name": "Самооценка",                 "score": <int>, "max": 25 }
            ]
        },
...
объедени данные и вадай структурированный отчёт
...
❗ ответ дай СТРОГО в формате JSON, без Markdown и комментариев.
❗ Используй только ключи из схемы и не добавляй новых.
